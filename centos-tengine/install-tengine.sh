...
cd /etc/rc.d/init.d
wget https://raw.githubusercontent.com/ivan-nginx/centos-tengine/master/etc/rc.d/init.d/nginx
chmod 755 /etc/rc.d/init.d/nginx
cd /etc/sysconfig
wget https://raw.githubusercontent.com/ivan-nginx/centos-tengine/master/etc/sysconfig/nginx
cd /etc/logrotate.d
wget https://raw.githubusercontent.com/ivan-nginx/centos-tengine/master/etc/logrotate.d/nginx
